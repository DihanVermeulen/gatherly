...
import { Eye, EyeOff, ArrowLeft, MoreVertical, Users, Gift, ChevronRight } from "lucide-react-native";
    ...
    <View className="flex-1 bg-background-0">
      ...
      >
        ...
        <View className="px-4 mt-4">
          ...
          >
            <Text className="font-bold text-lg mb-1" style={{ color: "#0f766e" }}>
            ...
            {memberCount === 0 ? (
              ...
              <View className="rounded-2xl border border-outline-100 overflow-hidden">
                {event.people.map((name, idx) => {
                  ...
                  const isOrganizer = isCurrentUser && user?.role === "organizer";
                  ...
                  return (
                    ...
                    >
                      ...
                      <Avatar
                        size="sm"
                        className={isOrganizer ? "bg-teal-500" : "bg-slate-400"}
                      >
